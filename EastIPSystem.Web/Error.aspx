<%@ Page Language="c#" AutoEventWireup="false" Inherits="EastIPInternalInvoiceSystem.Web.ErrorPage" EnableViewState="false"
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .PopupNewStyle .ClosePopupBT { display: block; }
    </style>
</head>
                                ...
                                <asp:Table ID="Table1" runat="server" Width="100%" BorderWidth="0px" CellPadding="0"
                                    ...
                                    <asp:TableRow ID="TableRow2" runat="server">
                                        <asp:TableCell runat="server" ID="ViewSite">
                                            <h2 id="FormCaption">
                                                <asp:Literal ID="ErrorTitleLiteral" runat="server" Text="Application Error"/>
                                            </h2>
                                            <asp:Panel runat="server" ID="ErrorPanel" Width="100%">
                                                ...
                                                <asp:Panel ID="Details" runat="server" Width="100%">
                                                    ...
                                                    <div id="DetailsContent" style="display: none;">
                                                        <span class="StaticText" style="font-weight: bold;">
                                                            Error details<hr width="100%"/>
                                                        </span><a style="cursor: hand; text-decoration: underline;" id="HideErrorDetails"
                                                                  onclick="javascript:HideDetails();">
                                                            Hide Error details
                                                        </a>
