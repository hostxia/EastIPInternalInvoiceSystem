...
namespace EastIPSystem.Module.BusinessObjects
{
    ...
    public static class PatentPaymentCodeCollection
    {
        ...
        static PatentPaymentCodeCollection()
        {
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, EnumsAll.PatentType.实用新型, "实用新型专利登记费", 150));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, EnumsAll.PatentType.实用新型, "实用新型专利公告印刷费", 50));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, null, "公布印刷费", 50));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, EnumsAll.PatentType.发明, "发明专利申请实质审查费", 2500));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, EnumsAll.PatentType.发明, "发明专利复审费", 1000));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, null, "著录事项变更费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, null, "优先权要求费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, null, "优先权恢复费", 1000));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, null, "恢复权利请求费", 1000));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, null, "专利文件副本证明费", 30));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, EnumsAll.PatentType.发明, "发明专利权无效宣告请求费", 3000));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, null, "延长期限请求费", 0));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, EnumsAll.PatentType.发明, "发明专利登记费", 200));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.PCT国家, EnumsAll.PatentType.发明, "发明专利公告印刷费", 50));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "公布印刷费", 50));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "发明专利申请实质审查费", 2500));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "发明专利登记费", 200));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "发明专利公告印刷费", 50));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.实用新型, "实用新型专利登记费", 150));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.实用新型, "实用新型专利公告印刷费", 50));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第1年年费", 600));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第2年年费", 600));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第3年年费", 600));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第4年年费", 900));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第5年年费", 900));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第6年年费", 1200));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第7年年费", 1200));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第8年年费", 1200));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第9年年费", 2000));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利第10年年费", 2000));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利年费滞纳金", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利申请费", 500));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利权评价报告请求费", 2400));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利复审费", 300));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利权无效宣告请求费", 1500));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利登记费", 150));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.外观设计, "外观设计专利公告印刷费", 50));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, null, "著录事项变更费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, null, "译文改正费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, null, "优先权恢复费", 1000));
            ...
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, null, "专利文件副本证明费", 30));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, null, "延长期限请求费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, null, "宽限费", 1000));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "布图设计登记费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "延长费(集成电路)", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "复审请求费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "著录事项变更手续费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "非自愿许可请求费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "恢复请求费", 0));
            listPatentPaymentCodes.Add(new PatentPaymentCode(EnumsAll.PayCaseType.国内, EnumsAll.PatentType.发明, "非自愿许可请求的裁决请求费", 0));
